...
yolo_msgs__msg__DetectionArray__create(void)
{
...
yolo_msgs__msg__DetectionArray__Sequence__init(yolo_msgs__msg__DetectionArray__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(yolo_msgs__msg__DetectionArray)) {
      return false;
    }
  ...
  yolo_msgs__msg__DetectionArray__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(yolo_msgs__msg__DetectionArray)) {
      return false;
    }
