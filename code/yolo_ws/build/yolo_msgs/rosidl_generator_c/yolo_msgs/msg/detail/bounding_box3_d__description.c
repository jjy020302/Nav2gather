...
static char yolo_msgs__msg__BoundingBox3D__FIELD_NAME__center[] = "center";
static char yolo_msgs__msg__BoundingBox3D__FIELD_NAME__size[] = "size";
static char yolo_msgs__msg__BoundingBox3D__FIELD_NAME__frame_id[] = "frame_id";

static rosidl_runtime_c__type_description__Field yolo_msgs__msg__BoundingBox3D__FIELDS[] = {
  {
    {yolo_msgs__msg__BoundingBox3D__FIELD_NAME__center, 6, 6},
    {
  ...
  {
    {yolo_msgs__msg__BoundingBox3D__FIELD_NAME__size, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {yolo_msgs__msg__BoundingBox3D__FIELD_NAME__frame_id, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription yolo_msgs__msg__BoundingBox3D__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {yolo_msgs__msg__BoundingBox3D__FIELDS, 3, 3},
    },
    {yolo_msgs__msg__BoundingBox3D__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
yolo_msgs__msg__BoundingBox3D__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *yolo_msgs__msg__BoundingBox3D__get_individual_type_description_source(NULL),
